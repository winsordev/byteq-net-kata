...
namespace net_kata.Data.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Data = table.Column<string>(type: "nvarchar(max)", maxLength: 51620, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HuespedHabitacion", x => new { x.HabitacionId, x.HuespedId });
                    table.ForeignKey(
                        name: "FK_HuespedHabitacion_Habitacion_HabitacionId",
                        column: x => x.HabitacionId,
                        principalTable: "Habitacion",
                        principalColumn: "HabitacionId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HuespedHabitacion_Huesped_HuespedId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HuespedHabitacion_HuespedId",
                table: "HuespedHabitacion",
                column: "HuespedId");
        }
